...
static void Task1(void *p_arg)
{
    ...
    while(1)                                                                             {			                                                  ;
        ...
        OSTimeDly(  (OS_TICK    )2                                                       , 
	                (OS_OPT     )OS_OPT_TIME_DLY                                         , 
	                (OS_ERR    *)&err)                                                   ;
        CAT24C_Selective_R(0x31, cc, strlen((char *)aa))                                 ;
        USART1_SendString(&cc[0], strlen((char *)cc))                                    ; 
        CAT24C_Page_W(0x01, bb, strlen((char *)bb))                                      ;
        OSTimeDly(  (OS_TICK    )200                                                     , 
	                (OS_OPT     )OS_OPT_TIME_DLY                                         , 
	                (OS_ERR    *)&err)                                                   ;
        CAT24C_Sequential_R(0x01, cc, strlen((char *)bb))                                ;
        USART1_SendString(&cc[0], strlen((char *)cc))                                    ;      
